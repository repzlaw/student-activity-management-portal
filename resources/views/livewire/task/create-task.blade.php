<div>
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
            <form class="p-5" wire:submit="saveTask">
                <div class="space-y-12 sm:space-y-16">
                    <div>
                        <h2 class="text-base font-semibold leading-7 text-gray-900 capitalize text-transform:">{{ $form_type }} Task</h2>
                        <p class="max-w-2xl mb-5 text-sm leading-6 text-gray-600">Fill out this form to {{ $form_type }} a task.</p>
                        ...
                        <div class="pb-12 space-y-8 border-b border-gray-900/10 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Write the name of the task.</p>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Select the type of task.</p>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Write a short description of the task.</p>
                                    @error('form.description') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>

                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                <label for="due_date" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Due Date
                                    <span class="error">*</span>
                                </label>
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model.live="form.due_date" type="datetime-local" name="due_date" id="due_date" 
                                        {{-- max="{{$form->complete_date}}" --}}
                                    ...
                                    @error('form.due_date') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>


                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                <label for="users" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Assign to
                                    <span class="error">*</span>
                                </label>
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <x-user-select wire:model="form.assigned_to" :options="$form->userOptions" :user="$form->assigned_to"></x-user-select>
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Assign a group member to Task</p>
                                    @error('form.assigned_to') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            {{-- <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                <label for="complete_date" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Complete Date
                                    <span class="error">*</span>
                                </label>
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model.live="form.complete_date" type="datetime-local" name="complete_date" id="complete_date" 
                                        min="{{$form->due_date}}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xl sm:text-sm sm:leading-6" required>
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Select complete date.</p>
                                    @error('form.complete_date') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div> --}}
                        </div>
                    </div>
