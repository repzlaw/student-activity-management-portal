<div>
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
            <form class="p-5" wire:submit="saveActivity">
                <div class="space-y-12 sm:space-y-16">
                    <div>
                        <h2 class="text-base font-semibold leading-7 text-gray-900 capitalize text-transform:">{{ $form_type }} Activity</h2>
                        <p class="max-w-2xl mb-5 text-sm leading-6 text-gray-600">Fill out this form to {{ $form_type }} an activity.</p>
                        ...
                        <div class="pb-12 space-y-8 border-b border-gray-900/10 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Write the name of the activity.</p>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Select the type of activity.</p>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Write a short description of the activity.</p>
                                    @error('form.description') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>

                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                <label for="provider" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Provider
                                    <span class="error">*</span>
                                </label>
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model="form.provider" name="provider" id="provider" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xl sm:text-sm sm:leading-6" required>
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Write the name of the provider.</p>
                                    @error('form.provider') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model.live="form.start_date" type="date" name="start_date" id="start_date" 
                                        max="{{$form->end_date}}"
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model.live="form.end_date" type="date" name="end_date" id="end_date" 
                                        min="{{$form->start_date}}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xl sm:text-sm sm:leading-6" required>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                <label for="hours" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Hours
                                    <span class="error">*</span>
                                </label>
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    <input wire:model="form.hours" type="number" name="hours" id="hours" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xl sm:text-sm sm:leading-6" required>
                                    <p class="mt-3 text-sm leading-6 text-gray-600">Type in the number of the hours spent.</p>
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                ...
                                <div class="mt-2 sm:col-span-2 sm:mt-0">
                                    ...
                                    >
                                        <!-- File Input -->
                                        {{-- <input wire:model="form.attachments" type="file" multiple name="attachments" id="attachments" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xl sm:text-sm sm:leading-6" required> --}}
                                      ...
                                      <PhotoIcon class="w-12 h-12 mx-auto text-gray-300" aria-hidden="true" />
                                        <div class="flex mt-4 text-sm leading-6 text-gray-600">
                                            <label for="file-upload" class="relative font-semibold text-indigo-600 bg-white rounded-md cursor-pointer focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                                <span>Upload a file</span>
                                                <input wire:model="form.attachments" id="file-upload" type="file" class="sr-only" multiple />
                                            </label>
                                            <p class="pl-1">or drag and drop</p>
                                        </div>
