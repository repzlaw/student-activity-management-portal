                                    ...
                                    <div class="p-4 rounded-md bg-blue-50">
                                        <div class="flex">
                                            ...
                                            <div class="flex-1 ml-3 md:flex md:justify-between">
                                                <p class="text-sm text-blue-700">No Activities Created.</p>
                                            </div>
                                        </div>
                                    </div>
                                @else
...
<script>
    document.addEventListener('livewire:initialized',()=>{
        ...
        @this.on('confirm-short-link-archive',(event)=>{
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "This activity will be unavailable for use and all details would be lost!",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    @this.dispatch('archive-activities', {
