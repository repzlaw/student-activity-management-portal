<x-guest-layout>
    <x-authentication-card>
        <x-slot name="logo">
            {{-- <x-application-mark class="block w-auto h-16" /> --}}
            <img src="{{ asset('kano.svg') }}" class="block w-auto h-5" width="20%" alt="Application Logo">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block w-full mt-1" type="email" name="email" :value="request()->input('email')" required autocomplete="username" />
            </div>
            ...
            <div class="mt-4">
                <x-input id="team_id" class="block w-full mt-1" type="hidden" name="team_id" :value="request()->input('team')" />
            </div>
